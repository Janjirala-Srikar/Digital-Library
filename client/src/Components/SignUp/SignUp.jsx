...
const SignUp = () => {
  ...
  const checkUserExists = async (email) => {
    try {
      const response = await axios.post('https://digital-library-g6z9.onrender.com/users/check-user', { email });
      return { 
  ...
  const handleSubmit = async (e) => {
   ...
   console.log(userData)
    try {
      const response = await axios.post('https://digital-library-g6z9.onrender.com/users/register', userData);
